...
(function(){
  ...
  // 자동차세 (지방세법 제127조, 승용자동차): 배기량 1cc당 세액표.
  // 차령 경감은 배기량 기준 비영업용 승용차에만 적용 (3년째 5%부터 매년 5%씩, 12년째 이상 50%).
  // 전기·수소차 등 그 밖의 승용자동차는 정액(비영업용 10만원, 영업용 2만원)이라 차령 경감이 없다.
  // 지방교육세(제151조)는 비영업용 승용자동차 자동차세의 30%로, 영업용에는 붙지 않는다.
  R.carTax={
    private:[[1000,80],[1600,140],[Infinity,200]],
    business:[[1000,18],[1600,18],[2000,19],[2500,19],[Infinity,24]],
    eduRatio:.3,evPrivate:100000,evBusiness:20000,ageStartYear:3,ageStep:.05,ageMax:.5
  };
