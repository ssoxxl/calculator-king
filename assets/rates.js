...
(function(){
  ...
  // 자동차세 (지방세법 제127조, 승용자동차): 배기량 1cc당 세액, 지방교육세 30%,
  // 차령 3년째부터 매년 5%씩 경감해 12년째 이상 50% 한도. 전기·수소차는 배기량이 없어 정액 10만원
  R.carTax={
    private:[[1000,80],[1600,140],[Infinity,200]],
    business:[[1000,18],[1600,18],[2000,19],[2500,19],[Infinity,24]],
    eduRatio:.3,evFlat:100000,ageStartYear:3,ageStep:.05,ageMax:.5
  };
